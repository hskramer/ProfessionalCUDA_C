...
// changing BDIM from 32 to 64 increased kernel performance by 1.6x . I decided to try this after profiling
...
{
	// I had to rename this because the same variable name is used in main to initialize the coefficients
	// for the read only memory. Once I made this change it worked.
